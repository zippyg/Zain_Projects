...
#define LS                     0.00063 /* Stator inductance, H
...
#define NOMINAL_CURRENT         9569
#define MOTOR_MAX_SPEED_RPM     5900 /*!< Maximum rated speed  */
#define MOTOR_VOLTAGE_CONSTANT  4.0 /*!< Volts RMS ph-ph /kRPM */
#define ID_DEMAG                -9569 /*!< Demagnetization current */
